...
<h2>PayU Biz - NONSEAMLESS INTEGRATION</h2>
...
<form id="payment_form" action="./PayU_Payment_action.php" method="POST">
  ...
  <input type="text" id="surl" name="surl" value="http://localhost/PayU/PHP_Kit/NonSeamless/PayU_Payment_Response.php"><br><br>

  <label for="lname">CURL:</label><br>
  <input type="text" id="curl" name="curl" value="http://localhost/PayU/PHP_Kit/NonSeamless/PayU_Payment_Response.php"><br><br>

  <label for="lname">FURL:</label><br>
  <input type="text" id="furl" name="furl" value="http://localhost/PayU/PHP_Kit/NonSeamless/PayU_Payment_Response.php"><br><br>
